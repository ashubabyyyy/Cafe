...
import 'package:cafe/screens/onboarding_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Navigationscreen(), // default screen
...
// Optional: You can keep this if you still want a counter example
